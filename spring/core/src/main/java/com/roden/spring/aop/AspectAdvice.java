...
public class AspectAdvice {
     ...
     */
    @Pointcut("execution(* com.roden.spring.aop.*.*(..))")
     ...
     * @param jp
     */
    @Before(value = "execution(* com.roden.spring.aop.*.*(..))")
     ...
     *            连接点
     */
    @Around(value = "execution(* com.roden.spring.aop.*.*(..))")
     ...
     * @param e
     */
    @AfterThrowing(value = "execution(* com.roden.spring.aop.*.*(..))", throwing = "e")
